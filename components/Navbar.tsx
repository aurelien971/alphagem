...
export default function Navbar() {
  ...
  const mobileLinkActive = lightNav ? "text-black/85" : "text-white/95";
  const mobileLinkIdle = lightNav ? "text-black/70" : "text-white/70";
      ...
      <div className={shellClass}>
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            {/* Theme: compact icon segmented control */}
            <div className={`flex items-center overflow-hidden rounded-full ${pillWrap}`}>
              <button
                ...
                className={[
                  segBase,
                  segBtn,
                  mode === "light" ? pillActive : pillIdle,
                ].join(" ")}
                title={t("theme.light")}
              >
              ...
              <button
                ...
                className={[
                  segBase,
                  segBtn,
                  mode === "system" ? pillActive : pillIdle,
                ].join(" ")}
                title={t("theme.auto")}
              >
            ...
            {/* Language: single segmented control */}
            <div className={`flex items-center overflow-hidden rounded-full ${pillWrap}`}>
              <button
                type="button"
        ...
        {/* Mobile links */}
        <div className={lightNav ? "border-t border-black/10 md:hidden" : "border-t border-white/15 md:hidden"}>
          <div className="mx-auto flex max-w-6xl flex-wrap gap-x-4 gap-y-2 px-4 py-3">
            <Link
              href="/"
              className={[
                "text-xs tracking-wide transition-colors hover:text-[#2A6E9F]",
                pathname === "/" ? mobileLinkActive : mobileLinkIdle,
              ].join(" ")}
            >
              {t("nav.home")}
            </Link>
            <Link
              ...
              className={[
                "text-xs tracking-wide transition-colors hover:text-[#2A6E9F]",
                pathname.startsWith("/about") ? mobileLinkActive : mobileLinkIdle,
              ].join(" ")}
            >
              {t("nav.about")}
            </Link>
            <Link
              ...
              className={[
                "text-xs tracking-wide transition-colors hover:text-[#2A6E9F]",
                pathname.startsWith("/services") ? mobileLinkActive : mobileLinkIdle,
              ].join(" ")}
            >
              {t("nav.services")}
            </Link>
            <Link
              ...
              className={[
                "text-xs tracking-wide transition-colors hover:text-[#2A6E9F]",
                pathname.startsWith("/portfolio") ? mobileLinkActive : mobileLinkIdle,
              ].join(" ")}
            >
              {t("nav.portfolio")}
            </Link>
            <Link
              ...
              className={[
                "text-xs tracking-wide transition-colors hover:text-[#2A6E9F]",
                pathname.startsWith("/contact") ? mobileLinkActive : mobileLinkIdle,
              ].join(" ")}
            >
              {t("nav.contact")}
            </Link>
